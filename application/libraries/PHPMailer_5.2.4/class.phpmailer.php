...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'info@jkolaz.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'I. E. P. Mi Jazmincito';
  ...
  */
   ...
   * @var string
   */
  public $Hostname          = 'mail.jkolaz.com';
   ...
   * @var string
   */
  public $Username      = 'j.salsavilca@jkolaz.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = '10557788177428';
