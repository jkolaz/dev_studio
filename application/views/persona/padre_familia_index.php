            ...
            <tbody>
                ...
                if ($lista) {
                    ...
                    foreach ($lista as $objeto) {
                        ...
                        echo "<td align='center'>" . utf8_encode($objeto->USUA_apellidoPaterno) . '</td>';
                        echo "<td align='center'>" . utf8_encode($objeto->USUA_apellidoMaterno) . '</td>';
                        echo "<td align='center'>" . utf8_encode($objeto->USUA_nombres) . '</td>';
                        echo "<td align='center'>" . $objeto->USUA_login . '</td>';
                        echo "<td align='center'>" . utf8_encode($objeto->ROL_nombre) . '</td>';
                        echo "<td align='center'>" . $objeto->hijos . '</td>';
