                    ...
                    <tbody>
                        ...
                        if ($listaDocumentos) {
                            ...
                            foreach ($listaDocumentos as $objeto) {
                                ...
                                $idDocumento = $objeto->DOCU_id;
                                $documento = $objeto->DOCU_nombre;

                                if (array_key_exists($idDocumento, $ENTREGADOS)) {
                                    $fecha = $ENTREGADOS[$idDocumento];
                                    $estado = 'ENTREGADO';
                                } else {
                                    $fecha = '-';
                                    $estado = 'PENDIENTE';
                                ...
                                echo "<td align='left'>" . $objeto->DOCU_nombre . '</td>';
